  ...
  return (
      <div id="Two"
          ...
          <div id="title" className="flex justify-start w-full text-left items-center gap-2">
                  <img className="2xl:w-19" alt="Two" src={twoIcon}/><p className="text-xl 2xl:text-4xl">{t(`sec2_title`)}</p>
          </div>
          <div className="items-start">
              <p className="text-sm pl-4 mt-2 text-left 2xl:pl-0 2xl:text-2xl">{t(`sec2_desc`)}</p></div>
