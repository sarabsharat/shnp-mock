...
function Sidebar() {
    ...
    return (
        <div className="flex flex-row w-full">
            <button ref={buttonRef} className="lg:hidden p-2" onClick={() => setIsMobileMenuOpen(!isMobileMenuOpen)}>
                {hamburger}
            </button>
            ...
            <div
                ...
                `}
            >
                <div className="p-3  w-full custom-font-reg border-r-2 h-full border-gray-300">

                    <img src={logo} className="w-1/2 mx-auto mb-6 max-w-[180px] lg:w-full lg:max-w-full" alt="Logo" />

                    <div className="flex flex-col w-full justify-start space-y-4">

                        <p className="text-sm lg:text-lg 2xl:text-xl text-gray-800 font-bold text-left">{t('main')}</p>
                        <ul className="lg:text-md 2xl:text-lg text-left space-y-1">
                            ...
                            <li className="flex justify-start items-center">
                                <button onClick={() => handleNavigation("manageEmployees")}
                                        className="custom-font-reg flex items-center gap-3 px-3 py-2 rounded-full w-full focus:bg-shnp-orange focus:text-white text-gray-400 active:bg-shnp-orange active:text-white hover:bg-shnp-orange-light hover:text-shnp-orange transition-colors duration-200"
                                >
                                    {employees} {t(`manageEmployees`)}
                                </button>
                            </li>
                        </ul>

                        <p className="text-sm lg:text-lg 2xl:text-xl text-gray-800 font-bold text-left pt-4">{t(`restaurant`)}</p>
                        <ul className="lg:text-md 2xl:text-lg text-left space-y-1">
                            <li className="flex justify-start items-center">
                                <button
                                    className="custom-font-reg flex items-center gap-3 px-3 py-2 rounded-full w-full focus:bg-shnp-orange focus:text-white text-gray-400 active:bg-shnp-orange active:text-white hover:bg-shnp-orange-light hover:text-shnp-orange transition-colors duration-200"
                        ...
                        <p className="text-sm lg:text-lg 2xl:text-xl text-gray-800 font-bold text-left pt-4">{t(`customersSubscriptions`)}</p>
                        <ul className="lg:text-md 2xl:text-lg text-left space-y-1">
                            <li className="flex justify-start items-center">
                                <button
                                    className="custom-font-reg flex items-center gap-3 px-3 py-2 rounded-full w-full focus:bg-shnp-orange focus:text-white text-gray-400 active:bg-shnp-orange active:text-white hover:bg-shnp-orange-light hover:text-shnp-orange transition-colors duration-200"
                            ...
                            <li className="flex justify-start items-center">
                                <button onClick={() => handleNavigation("subscription")}
                                        className="custom-font-reg flex items-center gap-3 px-3 py-2 text-left rounded-full w-full focus:bg-shnp-orange focus:text-white text-gray-400 active:bg-shnp-orange active:text-white hover:bg-shnp-orange-light hover:text-shnp-orange transition-colors duration-200"
                                >
                                    {CS} {t(`customersSubscriptions`)}
                                </button>
                            </li>
                        </ul>

                        <ul className="mt-4 border-t-2 border-gray-200 lg:text-md 2xl:text-lg text-left space-y-1 pt-4">
                            <li className="flex justify-start items-center">
                                <button
